 ...
 * @param n - размер массива
 */
void fillArray(int* array, const size_t n);
 ...
 */
int sumOfNegativeElementsDivisibleBy10(const int* array, const size_t n);
 ...
 */
void reverseFirstKElements(int* array, const size_t n, const int k);
 ...
 */
bool hasPairWithProduct(const int* array, const size_t n, const int target);
 ...
 */
int* copyArray(const int* arr, const size_t n);
